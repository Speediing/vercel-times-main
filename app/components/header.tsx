...
export const Header = () => (
  <header>
    <div className="flex flex-row px-1.5 text-sm py-2">
      <div className="flex flex-row flex-1">
        <ul className="flex flex-0 flex-row space-x-4 items-center">
          ...
          <li className="hidden lg:flex h-6 w-6 rounded-md items-center justify-center hover:bg-neutral-200 pointer">
            <svg viewBox="0 0 16 16" width={16} height={16}>
              <path
                fill="#333"
      ...
      <nav className="hidden lg:flex flex-1 items-center justify-center space-x-4 text-2xs font-medium uppercase">
      ...
      <div className="flex lg:hidden flex-1 text-center items-center justify-center">
        <Logo height={24} />
      </div>
      <div className="flex flex-row flex-1 justify-end items-center">
        <ul className="flex flex-0 flex-row space-x-4 h-[29px]">
          <li className="hidden lg:flex py-1.5 px-4 rounded-md bg-slate-500 hover:bg-slate-400 text-white uppercase font-extrabold text-[0.6875rem] items-center">
            Subscribe for $0.50/Week
          </li>
          <li className="hidden lg:flex py-1.5 px-4 rounded-md bg-slate-500 text-white uppercase font-extrabold text-[0.6875rem] items-center hover:bg-slate-400">
            Log In
          </li>
    ...
    <div className="hidden lg:grid relative py-2 border-gray-200 border-b items-center grid-cols-12">
      ...
      <div className="flex col-span-2 text-xs flex-col items-end">
        <div>
    ...
    <nav className="hidden lg:block border-b border-black pb-0.5">
    ...
    <div className="hidden lg:flex text-xs items-center justify-center font-semibold py-4">
